...
void dissas_line(bpf::insn* inst, size_t r)
{
    ...
    switch (code) {
        ...
        case JMP|JGT|K : printf(fmt, k, jt+r+1, jf+r+1); break;
        case JMP|JGE|K : printf(fmt, k, jt+r+1, jf+r+1); break;
        case JMP|JEQ|K : printf(fmt, k, jt+r+1, jf+r+1); break;
        case JMP|JSET|K: printf(fmt, k, jt+r+1, jf+r+1); break;
        case JMP|JGT|X : printf(fmt,    jt+r+1, jf+r+1); break;
        case JMP|JGE|X : printf(fmt,    jt+r+1, jf+r+1); break;
        case JMP|JEQ|X : printf(fmt,    jt+r+1, jf+r+1); break;
        case JMP|JSET|X: printf(fmt,    jt+r+1, jf+r+1); break;
